...
const char *ssid = "HUAWEI-z6K8";  //ENTER YOUR WIFI SETTINGS
const char *password = "PMwZmzYp";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.18.6/biometricattendance/getdata.php"; //computer IP or the server domain
